...
DiffbotInterface::~DiffbotInterface()
{
  if (arduino_.IsOpen())
  {
    ...
    {
      RCLCPP_FATAL_STREAM(rclcpp::get_logger("DiffbotInterface"),
...
CallbackReturn DiffbotInterface::on_activate(const rclcpp_lifecycle::State &)
{
  ...
  RCLCPP_INFO(rclcpp::get_logger("DiffbotInterface"),
...
hardware_interface::return_type DiffbotInterface::read(const rclcpp::Time &,
...
hardware_interface::return_type DiffbotInterface::write(const rclcpp::Time &,
                                                          const rclcpp::Duration &)
{
  ...
  {
    RCLCPP_ERROR_STREAM(rclcpp::get_logger("DiffbotInterface"),
