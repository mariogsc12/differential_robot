...
def generate_launch_description():
    ...
    diffbot_controller_pkg = get_package_share_directory("diffbot_controller")
    ...
    joy_teleop = Node(
        ...
        parameters=[os.path.join(diffbot_controller_pkg, "config", "joy_teleop.yaml"),
    ...
    joy_node = Node(
        ...
        executable="joy_node",
        name="joystick",
        parameters=[os.path.join(diffbot_controller_pkg, "config", "joy_config.yaml"),
                    {"use_sim_time": LaunchConfiguration("use_sim_time")}]
    )
