#include "diffbot_controller/noisy_controller.hpp"
...

{
    ...
    declare_parameter("wheel_separation",0.26);
    ...
    odom_pub_ = create_publisher<nav_msgs::msg::Odometry>("/diffbot_controller/odom_noisy", 10);

    odom_msg_.header.frame_id = "odom";
    odom_msg_.child_frame_id = "base_link_ekf";
